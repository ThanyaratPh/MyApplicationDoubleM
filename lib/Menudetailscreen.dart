...
import 'package:flutter_application_1/menuitem.dart';

class MenuDetailScreen extends StatelessWidget {
  final MenuItem menuItem;
  MenuDetailScreen(this.menuItem);
void sendToFirebase(MenuItem item, int insertedId) async {
            ...
            child: Container(
              ...
              child: ElevatedButton(
                  ...
                  int insertedId = await dbHelper.insertMenuItem({
                    ...
                    DatabaseHelper.columnIngredient: menuItem.ingredient.join(','),
                  });
